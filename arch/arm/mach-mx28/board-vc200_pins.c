...
static struct pin_desc vc200_fixed_pins[] = {
	/* Debug UART */
	{
		.name = "DUART.RX",
		.id = PINID_PWM0,
...
void vc200_enet_io_lowerpower_enter(void)
{
}

void vc200_enet_io_lowerpower_exit(void)
{
}

void __init vc200_pins_init(void)
{
	pingroup_init(vc200_fixed_pins, ARRAY_SIZE(vc200_fixed_pins));
}
