/*
 * Freescale MX28 Emerging Display ETV570G2DMU LCD panel driver
 * based on driver for ETQ570G0DH6
 *
 * Copyright (C) 2009-2010 Freescale Semiconductor, Inc. All Rights Reserved.
 * Copyright (C) 2011 TQ Systems GmbH. All Rights Reserved.
 *
...
/* #define LCD_DATBUS_WIDTH3 */
/* #define LCD_SWAP_XY */

#if 0
#define DOTCLK_H_ACTIVE  640
#define DOTCLK_H_PULSE_WIDTH 30
#define DOTCLK_HF_PORCH  144
#define DOTCLK_HB_PORCH  16
...
#define DOTCLK_H_ACTIVE  640
#define DOTCLK_H_PULSE_WIDTH 30
#define DOTCLK_HF_PORCH  (144 - DOTCLK_H_PULSE_WIDTH)
#define DOTCLK_HB_PORCH  16
#define DOTCLK_H_WAIT_CNT (DOTCLK_H_PULSE_WIDTH + DOTCLK_HB_PORCH)
#define DOTCLK_H_PERIOD (DOTCLK_H_WAIT_CNT + DOTCLK_HF_PORCH + DOTCLK_H_ACTIVE)
...
#define DOTCLK_V_ACTIVE  480
#define DOTCLK_V_PULSE_WIDTH  3
#define DOTCLK_VF_PORCH  (35 - DOTCLK_V_PULSE_WIDTH)
#define DOTCLK_VB_PORCH  10
#define DOTCLK_V_WAIT_CNT (DOTCLK_V_PULSE_WIDTH + DOTCLK_VB_PORCH)
#define DOTCLK_V_PERIOD (DOTCLK_VF_PORCH + DOTCLK_V_ACTIVE + DOTCLK_V_WAIT_CNT)
#endif
		      ...
		      struct mxs_platform_fb_entry *pentry)
{
	...
	printk("%s: H period %u\n", __func__, DOTCLK_H_PERIOD);
	printk("%s: H active %u\n", __func__, DOTCLK_H_ACTIVE);
	printk("%s: H pulse %u\n", __func__, DOTCLK_H_PULSE_WIDTH);
	printk("%s: V period %u\n", __func__, DOTCLK_V_PERIOD);
	printk("%s: V active %u\n", __func__, DOTCLK_V_ACTIVE);
	printk("%s: V pulse %u\n", __func__, DOTCLK_V_PULSE_WIDTH);
...
#if defined LCD_DATBUS_WIDTH3
			   DOTCLK_H_WAIT_CNT, DOTCLK_H_ACTIVE, 3,
#else
			   DOTCLK_H_WAIT_CNT, DOTCLK_H_ACTIVE, 2,
#endif
